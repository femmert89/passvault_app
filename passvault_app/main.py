"""
main.py – Interfaz principal del gestor passvault_app.

Este script inicia la interacción con el usuario y presenta el menú
de opciones para gestionar contraseñas cifradas de forma local.
"""
...
def main():
    ...
    para el gestor de contraseñas.

    Permite al usuario agregar, eliminar, visualizar contraseñas
    y salir del programa. Interactúa con el vault cifrado mediante
    una clave maestra definida por el usuario.
    """
